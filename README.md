...
2. Ссылку на GitHub-репозиторий с тестами.
3. Ссылку на GitHub-репозиторий с неправильной библиотекой, если она вынесена отдельно. В данном варианте она лежит в папке `wrong_lib` одного проекта.
